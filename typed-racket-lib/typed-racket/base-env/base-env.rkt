...
[caar (-poly (a b c)
             (cl->* [->acc (list (-pair (-pair a b) c)) a (list -car -car)]
                    [->acc (list (-lst (-pair a b))) a (list -car -car)]
                    [->acc (list (-pair (-lst a) b)) a (list -car -car)]
                    [->acc (list (-lst (-lst a))) a (list -car -car)]))]
[cdar (-poly (a b c)
             (cl->* [->acc (list (-pair (-pair a b) c)) b (list -cdr -car)]
                    [->acc (list (-lst (-pair a b))) b (list -cdr -car)]
                    [->acc (list (-pair (-lst a) b)) (-lst a) (list -cdr -car)]
                    [->acc (list (-lst (-lst a))) (-lst a) (list -cdr -car)]))]
[cadr (-poly (a b c)
             (cl->* [->acc (list (-pair a (-pair b c))) b (list -car -cdr)]
                    [->acc (list (-lst a)) a (list -car -cdr)]))]
[cddr  (-poly (a b c)
...
[tenth   (-poly (a b c d e f g h i r t)
              (cl->* [->acc (list (-lst* a b c d e f g h i r #:tail (-lst t))) r (list -car -cdr -cdr -cdr -cdr -cdr -cdr -cdr -cdr -cdr)]
                     [->acc (list (-lst a)) a (list -car -cdr -cdr -cdr -cdr -cdr -cdr -cdr -cdr -cdr)]))]
[rest (-poly (a b)
             (cl->*
