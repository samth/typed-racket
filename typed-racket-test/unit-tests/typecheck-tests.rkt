...
;                (-lst* -One -String -Char)] TODO(AMK) uncomment
        ...
        [tc-err (let*: ([x : Any 1]
                       ...
                       (if (number? x)
                           (begin (f) (add1 x))
                           12))
          #:ret (ret -PosByte -true-filter (-int-obj 12))]
